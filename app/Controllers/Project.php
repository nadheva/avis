...
class Project extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->mail->Host       = 'astra-visteon.com';
        $this->mail->SMTPAuth   = true;
        $this->mail->Username   = 'avis-bot@astra-visteon.com';
        $this->mail->Password   = 'Avi123!';
        $this->mail->SMTPSecure = 'tls';
        $this->mail->SMTPAutoTLS = true;
        $this->mail->Port       = 587;
        $this->mail->FromName = "No-Reply Avis";
        $this->mail->From = "avis-bot@astra-visteon.com";
    ...
    { 
        ...
        try {
            $this->mail->addAddress('risky.aditp06@gmail.com');
            $this->mail->isHTML(true);
            // Content
            $this->mail->isHTML(true);
            $this->mail->Subject = 'New Task from AVIS';
            $body = "";
            ...
            // $body .= "or <a href='10.14.81.14:8080/avis/login'>click this link</a><br><br><br>";
            $body .= "Regards,<br><br>";
            $body .= "AVIS Mail Bot";
            $this->mail->Body = $body;
            $this->mail->send();
