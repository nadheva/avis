        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="text-right">
                    <a href="<?= base_url('') ?>/drawing/model/<?= $file->id_model ?>" class="badge badge-secondary">⬅ Back</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-xl">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('') ?>/drawing/updatefile/<?= $file->id ?>" method="POST" enctype="multipart/form-data">
                            <?= csrf_field() ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" name="exampleRadios" id="exampleRadios1" value="active" <?= ($file->status == 'active') ? 'checked' : '' ?> >
                                            <label class="custom-control-label" for="exampleRadios1">
                                                Active
                                            </label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" name="exampleRadios" id="exampleRadios2" value="inactive" <?= ($file->status == 'inactive') ? 'checked' : '' ?>>
