            ...
            <div class="col-6">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page"><a href="<?= base_url('') ?>/engchange/fourm/<?= $projectrow->id ?>"><?= $projectrow->project_name ?></a></li>
                        <li class="breadcrumb-item" aria-current="page"><?= $fourmrow->fourm ?></li>
                    </ol>
                </nav>
            </div>
            <div class="col-6">
                <div class="text-right">
                    <a href="<?= base_url('') ?>/engchange/fourm/<?= $projectrow->id ?>" class="badge badge-secondary">⬅ Back</a>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="project" readonly value="<?= $projectrow->project_name ?>" class="form-control">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="">4M</label>
                                        <input type="text" name="fourm" readonly value="<?= $fourmrow->fourm ?>" class="form-control">
                                        <input type="hidden" name="fourm_id" value="<?= $fourmrow->id ?>" >
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="card file">
                                                <div class="file-options dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" target="_blank"
                                                            href="<?= base_url('public') ?>/theme/assets/4m change request/<?= $projectrow->project_name ?>/<?=  $fourmrow->fourm  ?>/<?= $row->file ?>">View</a>
                                                ...
                                                <div class="card-body file-info">
                                                    ...
                                                    <span class="file-size">
                                                        <?php
                                                                        $filesize = filesize('public/theme/assets/4m change request/' . $projectrow->project_name . '/' . $fourmrow->fourm. '/'. $row->file);
                                                                        if ($filesize >= 1048576) {
