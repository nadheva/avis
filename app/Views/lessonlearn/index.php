                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a type="button" style="color: white;" 
                                                onclick="view(<?= $row->id ?>)" class="badge badge-info" data-toggle="tooltip" data-placement="top" title="View">
                                                <span class="material-icons">visibility</span></a>
                                            <?php if(user()->department_id == "3") :  ?>
                                                <span data-toggle="modal" data-target="#editLesson">
                                                    <a type="button" onclick="edit(<?= $row->id ?>)" class="badge badge-primary" type="button"  data-toggle="tooltip" data-placement="top" title="Edit"><span class="material-icons" style="color: white;">edit</span></a>
                                                </span>
