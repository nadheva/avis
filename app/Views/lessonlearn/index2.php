                            ...
                            <tbody>
                                ...
                                <?php foreach ($allLesson as $row) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a data-toggle="modal" type="button" style="color: white;" data-target="#viewLesson<?= $row->id ?>" class="badge badge-info"><span class="material-icons">visibility</span></a>
                                            <?php if(user()->department_id == "3") :  ?>
                                                <a type="button" class="badge badge-primary" data-toggle="modal" type="button" data-target="#editLesson<?= $row->id ?>"><span class="material-icons" style="color: white;">edit</span></a>
                                                <a type="button" class="badge badge-danger" onclick="del(<?= $row->id; ?>)"><span class="material-icons" style="color: white;">delete</span></a>
                                            <?php endif ?>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="project" readonly value="" class="form-control">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
