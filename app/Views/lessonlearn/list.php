...
<div class="page-content">
        ...
        <div class="row">
            <div class="col-6">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?= base_url('') ?>/lessonlearn">Lesson Learn</a></li>
            ...
            <div class="col-6">
                <div class="text-right">
                    <a href="<?= base_url('') ?>/lessonlearn" class="badge badge-secondary">⬅ Back</a>
                </div>
            </div>
        </div>
    </div>
    <div class="main-wrapper">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($lessonlearn as $r) : ?>
                                    <tr>
                                        ...
                                        <td><?= $r->rootcause ?></td>
                                        <td>
                                            <span class="bcstm bcstm-<?= $r->status == 'Open' ? 'danger' : 'primary' ?>"><?= $r->status ?></span>
                                        </td>
                                        <td>
                                            ...
                                            <?php if(user()->department_id == "3") :  ?>
                                                <a type="button" class="badge badge-primary" data-toggle="modal" type="button" data-target="#editLesson<?= $r->id ?>"><span class="material-icons" style="color: white;">edit</span></a>
                                                <a type="button" class="badge badge-danger" onclick="del(<?= $r->id; ?>, <?= $project->id ?>)"><span class="material-icons" style="color: white;">delete</span></a>
                                            <?php endif ?>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="project" readonly value="<?= $project->project_name ?>" class="form-control">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
        ...
        <!-- Modal Detail Lesson -->
        <?php foreach($lessonlearn as $row) : ?>
        ...
        <script>
            function del(id, idl) {
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            location.replace(`<?= base_url('/lessonlearn/deletelesson') ?>/${id}/${idl}`)
                        } else {
