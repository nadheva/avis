...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Okt 2021 pada 11.53
...
INSERT INTO `approval` (`id`, `task_id`, `file`, `approve_user`, `update_date`, `notes`, `approve`, `routes`, `updated`) VALUES
(5, 3, 'dummies.pdf', 12, '2021-09-27', 'Sip, Lanjutkan!Sip, Lanjutkan!Sip, Lanjutkan!Sip, Lanjutkan!Sip, Lanjutkan!Sip, Lanjutkan!Sip, Lanjutkan!Sip, Lanjutkan!Sip, Lanjutkan!Sip, Lanjutkan!', 202, 1, 1),
(6, 3, 'dummies.pdf', 38, '2021-09-27', 'Well Done!', 202, 2, 1),
(7, 4, 'dummiessss.pdf', 12, '2021-09-27', 'nice', 202, 1, 1),
(8, 4, 'dummiessss.pdf', 36, '2021-09-27', 'good!', 202, 1, 1),
(9, 5, 'dummiessss.pdf', 12, '2021-09-29', 'Sippp', 202, 1, 1),
(10, 6, 'dummiessss.pdf', 38, '2021-09-30', 'Sip', 202, 1, 1),
(11, 6, 'dummiessss.pdf', 36, '2021-09-30', 'Ok', 202, 2, 0),
(12, 7, 'dummies.pdf', 28, '2021-10-01', 'lanjutkan', 202, 1, 1),
(13, 7, 'dummies.pdf', 38, '2021-10-01', 'okee bagus', 202, 2, 1),
(16, 8, NULL, 12, '2021-10-04', 'Sipp', 202, 1, 1),
(17, 8, NULL, 38, '2021-10-04', 'Good', 202, 1, 1),
(18, 9, 'dummies.pdf', 12, '2021-10-07', 'Bagus lanjutkan!', 202, 1, 1),
(19, 9, 'dummies.pdf', 38, '2021-10-07', 'Sipss', 202, 2, 1),
(20, 9, 'dummies.pdf', 36, '2021-10-07', 'Mantapp', 202, 3, 1),
(21, 10, NULL, 65, '2021-10-21', NULL, 1, 1, 0),
(22, 10, NULL, 68, '2021-10-21', NULL, 1, 1, 0),
(23, 10, NULL, 36, '2021-10-21', NULL, 2, 2, 0);
...
(8, 8, NULL, 12, NULL, NULL, 0, 0),
(9, 9, 'dummies (1).pdf', 39, '2021-10-21', 'Good', 202, 1),
(10, 10, NULL, 12, NULL, NULL, 0, 0);
...
INSERT INTO `bom_approval_status` (`id`, `id_bom`, `request_status`, `user_approval`, `approve`) VALUES
(1, 3, 'inactive', 38, 202),
...
(3, 1, 'dummies.pdf', 'active', 'notes ex', '2021-09-06', 3, 1, 28),
...
INSERT INTO `budget` (`id`, `project_id`, `total`, `tooling`, `used_tooling`, `smt`, `used_smt`, `fa`, `used_fa`) VALUES
(1, 2, 0, 0, 0, 0, 0, 0, 0),
(3, 4, 0, 0, 0, 0, 0, 0, 0);
...
(2, 10, 'make approval ', '2021-10-22', 24, 'In Progress', '', NULL, 0, 'Yes');
...
INSERT INTO `child_task` (`id`, `task_id`, `concern`, `due_date`, `pic`, `status`, `description`, `approve`, `file`) VALUES
(3, 4, 'Review BOM', '2021-09-30', 31, 'Done', 'Ex desc', 2, 'No'),
(4, 4, 'Example child task 1', '2021-10-11', 31, 'Done', 'Maaf terlambat', 2, 'Yes'),
(5, 8, 'Child Task 3', '2021-10-12', 22, 'Done', 'Sudah dikerjakan', 2, 'Yes'),
(6, 9, 'Child task bayu', '2021-10-10', 24, 'Done', 'ini deskripsi child task', 2, 'No');
...
INSERT INTO `child_task_approval` (`id`, `child_task_id`, `file`, `approve_user`, `update_date`, `notes`, `approve`, `routes`, `updated`) VALUES
(3, 3, NULL, 22, '2021-09-28', 'Sipp', 202, 1, 1),
(4, 4, 'dummies.pdf', 22, '2021-09-30', 'Bagusss', 202, 1, 1),
(5, 5, 'dummiessss.pdf', 28, '2021-10-05', 'Sip', 202, 1, 1),
(6, 6, NULL, 25, '2021-10-07', 'Mantapp lanjutkan!', 202, 1, 1);
...
INSERT INTO `dwg_file` (`id`, `id_model`, `nama_file`, `status`, `uploader`, `upload_for_dept`) VALUES
(1, 1, 'dummies (10).pdf', 'active', 1, 1),
(2, 1, 'VPDS.xlsx', 'active', 28, 3),
(3, 1, 'dummies.pdf', 'active', 28, 3);
...
INSERT INTO `event_internal` (`id`, `project_id`, `event_name`, `start`, `end`) VALUES
(1, 2, 'PP1', '2021-09-03', '2021-09-15'),
(2, 2, 'PP2', '2021-09-16', '2021-09-20'),
(3, 2, 'PP3', '2021-09-21', '2021-10-11'),
(4, 2, 'MASS PRO', '2021-10-11', '2021-11-24');
...
INSERT INTO `launch_cost` (`id`, `project_id`, `total`, `pv`, `used_pv`, `launch`, `used_launch`, `other`, `used_other`) VALUES
(2, 2, 0, 0, 0, 0, 0, 0, 0),
(4, 4, 0, 0, 0, 0, 0, 0, 0);
...
INSERT INTO `lessonlearn` (`id`, `project_id`, `source`, `problem`, `countermeasure`, `rootcause`, `prevention`, `remaks`, `status`, `created_at`) VALUES
(7, 2, 'Development', 'Exampple problem', 'Example countermeasure', 'Example rootcause', 'Example prevention', 'Example remaks', 'Open', '2021-10-21'),
(8, 2, 'Manufacturing', 'papapa', 'dsds', 'aa', 'ada', 'ada', 'Closed', '2021-10-21'),
(9, 2, 'Customer', 'aad', 'asa', 'adad', 'dad', 'aaf', 'Open', '2021-10-21');
...
INSERT INTO `material_cost` (`id`, `project_id`, `total`, `mcomp`, `used_mcomp`, `ecomp`, `used_ecomp`) VALUES
(2, 2, 0, 0, 0, 0, 0),
(4, 4, 0, 0, 0, 0, 0);
...
INSERT INTO `productivity` (`id`, `project_id`, `event_id`, `station`, `ct_target`, `ct_actual`, `ftt_target`, `ftt_actual`, `rr_target`, `rr_actual`, `at_target`, `at_actual`) VALUES
(1, 2, 1, 'ICT', 25, 24, 30, 31, 25, 23, 30, 25),
(2, 2, 1, 'FCT', 25, 34, 30, 34, 25, 35, 30, 20),
(4, 2, 2, 'Station 1', 30, 22, 25, 34, 35, 41, 40, 30),
(5, 2, 2, 'Station 2', 30, 22, 25, 22, 35, 42, 40, 35),
(6, 2, 3, 'Station 1', 80, 98, 20, 19, 30, 11, 40, 27),
(9, 2, 1, 'EOL', 25, 20, 30, 25, 25, 15, 30, 22),
(10, 2, 1, 'PDI', 25, 15, 30, 20, 25, 15, 30, 25),
(11, 2, 1, 'AOI', 25, 20, 30, 25, 25, 10, 30, 15),
(12, 2, 3, 'Station 2', 80, 40, 30, 20, 30, 35, 50, 30),
(13, 2, 2, 'Station 3', 30, 35, 25, 15, 35, 40, 40, 25);
...
INSERT INTO `project` (`id`, `cust_id`, `project_name`, `end_product`, `start`, `status`, `pict`) VALUES
(2, 1, 'K2SA', 'PWBA', '2021-09-07', 'In Progress', '1633657183_8f8d2db106d771549c71.jpg'),
(4, 1, 'K1ZA', 'PWBA', '2021-10-05', 'In Progress', '1633415962_efa964930442776c964c.jpg');
...
INSERT INTO `quality` (`id`, `project_id`, `event`, `date`, `issue`, `description`, `lead`, `status`, `closing_action`) VALUES
(2, 2, '1', '2021-09-08', 'Issue Quality 1', 'Description Issue Quality', 39, 'Closed', 'Closing Action Example 1');
...
INSERT INTO `quality_cas` (`id`, `project_id`, `component`, `supplier`, `sc_point`, `all_point`, `cpcpk_compliance`, `visual`, `component_level_testing`, `eser_aar_status`, `remark`, `lead`, `status`, `flag`) VALUES
(1, 2, 'Mask', 'ASKI', 100, 85, 90, 'Clock Issue', 'N/A', 'Open', '-', 39, 'Open', 'Red');
...
INSERT INTO `quality_custppap` (`id`, `project_id`, `event`, `required_items`, `submission_date`, `pic`, `status`, `flag`) VALUES
(3, 2, '1', 'Example Items 1', '2021-09-15', 31, 'Open', 'Yellow');
...
INSERT INTO `quality_pvtest` (`id`, `project_id`, `test_item`, `plan_start`, `plan_completed`, `actual_start`, `actual_completed`, `result`, `flag`) VALUES
(1, 2, 'Example test 1', '2021-09-09', '2021-09-16', '2021-09-10', '2021-09-17', 'Oke', 'Yellow');
...
INSERT INTO `quality_pvtestsum` (`id`, `project_id`, `total_test`, `test_done`, `past_first_test`, `flag`) VALUES
(1, 2, 11, 1, 50, 'Yellow');
...
INSERT INTO `quality_safelaunch` (`id`, `project_id`, `event`, `date`, `issue`, `description`, `lead`, `status`, `closing_action`) VALUES
(2, 2, '1', '2021-09-08', 'Issue Safe Launch Quality 1', 'Description Issue Quality', 39, 'Open', 'Closing Action Ex');
...
INSERT INTO `quality_supppap` (`id`, `project_id`, `supplier`, `component`, `target_date`, `pic`, `status`, `flag`) VALUES
(4, 2, 'Example supplier 1', 'Example componen 1', '2021-09-11', 22, 'Open', 'Red');
...
(8, 2, 'Oportunity', 'Oportunity title', '2021-10-14', 30, 1, 'In Progress', 'deskripsi oportunity', NULL, '', 'No'),
(9, 2, 'Risk', 'Improve Mesin glue', '2021-10-28', 25, 1, 'Done', '', 'Okee', '', 'Yes'),
(10, 2, 'Risk', 'Packaging approval', '2021-10-28', 30, 1, 'In Progress', 'Submit doc to AMir', NULL, '1121 supplier', 'Yes');
...
INSERT INTO `task` (`id`, `project_id`, `event`, `concern`, `due_date`, `pic`, `description`, `status`, `approve`, `file`) VALUES
(3, 2, 1, 'Cluster Build', '2021-09-30', 28, 'sudah diperbaiki', 'Done', 3, 'Yes'),
(4, 2, 2, 'Material Development', '2021-10-05', 22, 'desc', 'Done', 2, 'Yes'),
(5, 2, 3, 'Research Development', '2021-10-08', 28, 'Okay', 'Done', 2, 'No'),
(6, 2, 2, 'Example Task 1', '2021-10-07', 40, 'Sip', 'Done', 2, 'Yes'),
(7, 2, 1, 'Example Task 2', '2021-10-08', 22, 'yayaya', 'Done', 3, 'Yes'),
(8, 2, 2, 'Example Task 3', '2021-10-07', 28, 'Ok', 'Done', 2, 'No'),
(9, 2, 2, 'Task 1', '2021-10-14', 25, 'ini deskripsiiii', 'Done', 4, 'Yes'),
(10, 2, 1, 'PFMEA PP2 FA', '2021-10-28', 25, NULL, 'In Progress', 1, 'Yes');
...
(1, 'juang@astra-visteon.com', 'Juang Sabit Al Nadiev', 1, 0, 0, 'Site Administartor', 'admin', '1626310631_7a51cb522cfe67f2ca56.png', '$2y$10$PZ73bsJ7XxXBaWFecmDpUu6o8YpGLw/tXYKUK.zmi0tEYtqOOB11a', NULL, NULL, NULL, 'af2bc21f264963091002b606016a4009', NULL, NULL, 1, 0, '2021-07-06 02:58:37', '2021-07-06 02:58:37', NULL),
(12, 'amirudin.suryo@astra-visteon.com', 'Amirudin Atmojo', 3, 0, 0, 'AME', 'ame', 'profile-image.png', '$2y$10$PZ73bsJ7XxXBaWFecmDpUu6o8YpGLw/tXYKUK.zmi0tEYtqOOB11a', NULL, NULL, NULL, '33210eece7a6e1e415820b9f1c213e71', NULL, NULL, 1, 0, '2021-07-07 14:09:51', '2021-07-07 14:09:51', NULL),
...
(23, 'alnadiev@astra-visteon.com', 'Al Nadiev', 7, 1, 1, 'AME', 'ame', '1626052502_698487a4266eb32d3065.png', '$2y$10$PZ73bsJ7XxXBaWFecmDpUu6o8YpGLw/tXYKUK.zmi0tEYtqOOB11a', NULL, NULL, NULL, '76a0d5e34d507f5d0095ba94a1197b3d', NULL, NULL, 1, 0, '2021-07-09 10:02:34', '2021-07-09 10:02:34', NULL),
...
(28, 'bimo.prakoso@astra-visteon.com', 'Bimo Prakoso', 6, 2, 13, 'RnD', 'user', 'profile-image.png', '$2y$10$PZ73bsJ7XxXBaWFecmDpUu6o8YpGLw/tXYKUK.zmi0tEYtqOOB11a', NULL, NULL, NULL, 'cf4db1e3bf66d04824df0af3294e0b5b', NULL, NULL, 1, 0, '2021-07-14 07:45:27', '2021-07-14 07:45:27', NULL),
...
(31, 'eko.prasetyo@astra-visteon.com', 'Eko Prasetyo', 6, 9, 12, 'Production', 'user', 'profile-image.png', '$2y$10$PZ73bsJ7XxXBaWFecmDpUu6o8YpGLw/tXYKUK.zmi0tEYtqOOB11a', NULL, NULL, NULL, '504ef67dda4cadda1ccdf1a67c38e113', NULL, NULL, 1, 0, '2021-07-14 07:46:55', '2021-07-14 07:46:55', NULL),
...
(39, 'ade.sarastiti@astra-visteon.com', 'Ade Rukmi Sarastiti', 6, 3, 5, 'Quality Assurance', 'user', 'profile-image.png', '$2y$10$PZ73bsJ7XxXBaWFecmDpUu6o8YpGLw/tXYKUK.zmi0tEYtqOOB11a', NULL, NULL, NULL, '4ceb79f5af51b8d7ccff1ce7fc762f42', NULL, NULL, 1, 0, '2021-08-31 14:48:54', '2021-08-31 14:48:54', NULL),
...
(69, 'syabanul.khafi@astra-visteon.com', 'Syabanul Khafi Tanjung', 7, 1, 3, '', 'user', 'profile-image.png', '$2y$10$S.eCjGh9K74h0GJV.hvoQefoBULwARrfxLdMfig.RVFvwyIDzKX9a', NULL, NULL, NULL, 'daaeb8d6b6dc4f3312c37551cbd810c2', NULL, NULL, 1, 0, '2021-10-15 09:00:08', '2021-10-15 09:00:08', NULL),
(70, 'jaka.maulana@astra-visteon.com', 'Jaka Maulana Purba', 7, 1, 4, '', 'user', 'profile-image.png', '$2y$10$XkBJSwVOKeO2pRM8rzSaTez/koJYISJewLfOY/1uY.RVXFZAVjTr.', NULL, NULL, NULL, '748b7b11d00ab210bb5caec4979df312', NULL, NULL, 1, 0, '2021-10-15 09:01:35', '2021-10-15 09:01:35', NULL);
...
--
ALTER TABLE `event_customer`
  ADD CONSTRAINT `event_customer_ibfk_1` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Ketidakleluasaan untuk tabel `event_internal`
--
ALTER TABLE `event_internal`
  ADD CONSTRAINT `event_internal_ibfk_1` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
