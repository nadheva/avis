...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 28 Okt 2021 pada 07.06
...
INSERT INTO `approval` (`id`, `task_id`, `approve_user`, `update_date`, `notes`, `approve`, `routes`, `updated`) VALUES
(5, 3, 12, '2021-09-27', 'Sip, Lanjutkan!Sip, Lanjutkan!Sip, Lanjutkan!Sip, Lanjutkan!Sip, Lanjutkan!Sip, Lanjutkan!Sip, Lanjutkan!Sip, Lanjutkan!Sip, Lanjutkan!Sip, Lanjutkan!', 202, 1, 1),
(6, 3, 38, '2021-09-27', 'Well Done!', 202, 2, 1),
(7, 4, 12, '2021-09-27', 'nice', 202, 1, 1),
(8, 4, 36, '2021-09-27', 'good!', 202, 1, 1),
(9, 5, 12, '2021-09-29', 'Sippp', 202, 1, 1),
(10, 6, 38, '2021-09-30', 'Sip', 202, 1, 1),
(11, 6, 36, '2021-09-30', 'Ok', 202, 2, 0),
(12, 7, 28, '2021-10-01', 'lanjutkan', 202, 1, 1),
(13, 7, 38, '2021-10-01', 'okee bagus', 202, 2, 1),
(16, 8, 12, '2021-10-04', 'Sipp', 202, 1, 1),
(17, 8, 38, '2021-10-04', 'Good', 202, 1, 1),
(18, 9, 12, '2021-10-07', 'Bagus lanjutkan!', 202, 1, 1),
(19, 9, 38, '2021-10-07', 'Sipss', 202, 2, 1),
(20, 9, 36, '2021-10-07', 'Mantapp', 202, 3, 1),
(21, 10, 65, '2021-10-21', 'Nice', 202, 1, 1),
(22, 10, 68, '2021-10-21', 'Good', 202, 1, 1),
(23, 10, 36, '2021-10-21', 'Yes', 202, 2, 1),
(24, 12, 12, '2021-10-22', 'Nice', 202, 1, 1),
(25, 12, 65, '2021-10-22', 'Good job!', 202, 2, 1),
(26, 13, 12, '2021-10-22', 'Good', 202, 1, 1);
...
(16, 1, 'dummiessss.pdf', 'inactive', 'Example Desc', '2021-09-23', 3, 1, 28),
(17, 1, 'dummiessss (1).pdf', 'inactive', 'Ex desc', '2021-10-07', 3, 1, 28),
(18, 1, 'equipspec.pdf', 'active', 'Cobaa', '2021-10-13', 3, 1, 28),
(19, 1, 'CCTC-VideoScripts.pdf', 'Rejected', 'BOM K1ZA for Maxim Rev 13', '2021-10-27', 404, 1, 38),
(20, 1, '20151116-T17applique.xlsx', 'Approve 1', 'Please approve', '2021-10-27', 2, 1, 38),
(21, 1, 'dummies.zip', 'Waiting Approve', 'Bom 27-10-21', '2021-10-27', 1, 1, 28);
...
INSERT INTO `child_task` (`id`, `task_id`, `concern`, `due_date`, `pic`, `status`, `namafile`, `description`, `approve`, `file`) VALUES
(5, 8, 'Child Task 3', '2021-10-12', 22, 'Done', 'dummiessss.pdf', 'Sudah dikerjakan', 2, 'Yes'),
(6, 9, 'Child task bayu', '2021-10-10', 24, 'Done', NULL, 'ini deskripsi child task', 2, 'No');
...
(1, 1, 'dummies (10).pdf', 'inactive', 1, 1),
(2, 1, 'VPDS.xlsx', 'active', 28, 3),
(3, 1, 'dummies.pdf', 'active', 28, 3),
(4, 1, 'CCTC-VideoScripts.pdf', 'active', 38, 3);
...
(4, 2, 'MASS PRO', '2021-10-11', '2021-11-22');
...
(7, 2, 'Design', 'Exampple problem', 'Example countermeasure', 'Example rootcause', 'Example prevention', 'Example remaks', 'Closed', 'dummies.pdf', '2021-10-21'),
(8, 2, 'Manufacturing', 'papapa', 'dsds', 'aa', 'ada', 'ada', 'Closed', NULL, '2021-10-21'),
(9, 2, 'Customer', 'aad', 'asa', 'adad', 'dad', 'aaf', 'Closed', NULL, '2021-10-21'),
(12, 2, 'Manufacturing', 'Exm problem', 'Exm countermeasure', 'Exm rootcause', 'Exm prevention', 'Exm remaks', 'Open', 'dummies.zip', '2021-10-25'),
(13, 4, 'Customer', 'dd', 'ss', 'dd', 'dd', 'aa', 'Closed', NULL, '2021-10-25');
...
INSERT INTO `task` (`id`, `project_id`, `event`, `concern`, `due_date`, `pic`, `namafile`, `description`, `status`, `approve`, `file`, `created_at`, `request_at`) VALUES
(3, 2, 1, 'Cluster Build', '2021-09-30', 28, 'dummies.pdf', 'sudah diperbaiki', 'Done', 3, 'Yes', '2021-10-07 09:10:52', '2021-10-01 09:13:57'),
(4, 2, 2, 'Material Development', '2021-10-05', 22, 'dummiessss.pdf', 'desc', 'Done', 2, 'Yes', '2021-10-05 09:11:00', '2021-10-04 09:14:05'),
(5, 2, 3, 'Research Development', '2021-10-08', 28, 'dummiessss.pdf', 'Okay', 'Done', 2, 'No', '2021-10-11 09:02:05', '2021-10-10 09:14:08'),
(6, 2, 2, 'Example Task 1', '2021-10-07', 40, 'dummiessss.pdf', 'Sip', 'Done', 2, 'Yes', '2021-10-13 09:11:16', '2021-10-20 09:14:12'),
(7, 2, 1, 'Example Task 2', '2021-10-08', 22, 'dummies.pdf', 'yayaya', 'Done', 3, 'Yes', '2021-10-18 09:11:21', '2021-10-11 09:14:15'),
(8, 2, 2, 'Example Task 3', '2021-10-07', 28, NULL, 'Ok', 'Done', 2, 'No', '2021-10-19 09:11:24', '2021-10-17 09:14:20'),
(9, 2, 2, 'Task 1', '2021-10-14', 25, 'dummies.pdf', 'ini deskripsiiii', 'Done', 4, 'Yes', '2021-10-21 09:11:27', '2021-10-19 09:14:23'),
(10, 2, 1, 'PFMEA PP2 FA', '2021-10-28', 25, 'dummies.pdf', 'Oks', 'Done', 3, 'Yes', '2021-10-22 09:11:30', '2021-10-21 09:14:25'),
(12, 2, 2, 'Test', '2021-10-29', 22, 'zzz.pdf', 'Example desciption', 'Done', 3, 'Yes', '2021-10-22 09:50:29', '2021-10-22 00:00:00'),
(13, 2, 2, 'Test2', '2021-10-30', 22, NULL, 'Yak', 'Done', 2, 'No', '2021-10-22 10:08:13', '2021-10-22 00:00:00');
...
(76, 'awang.dwi@astra-visteon.com', 'Awang Dwi Andhika', 6, 4, 9, '', 'user', 'profile-image.png', '$2y$10$5x44Qev.DhnSidC/8nvh1OJpOE9UJkzgjmMTQXpaGqjLlUJ25ycF6', NULL, NULL, NULL, '57e87e2b390f7271de49570e4b887179', NULL, NULL, 1, 0, '2021-10-26 09:28:14', '2021-10-26 09:28:14', NULL),
